  ...
  return (
    <main className='mx-auto max-w-6xl px-4 py-12 md:py-16'>
        ...
        <div className='grid gap-4 md:grid-cols-3'>
          {featuredRoles.map((role) => (
            <article key={role.title} className='card'>
              <p className='text-xs font-semibold uppercase tracking-wide text-slate-400'>Verified role</p>
              <h3 className='mt-2 text-lg font-semibold text-slate-50'>{role.title}</h3>
      ...
      <section className='mt-12 rounded-3xl border border-brand-400/30 bg-gradient-to-r from-brand-600/20 via-brand-500/10 to-info/10 p-8 md:p-10'>
        <h2 className='text-2xl font-semibold text-slate-50 md:text-3xl'>Ready to stop endless scrolling?</h2>
